...
export class PragmaticStepfuncStack extends cdk.Stack {
	constructor(scope: Construct, id: string, props?: cdk.StackProps) {
		...
		new S3ToStepfunctions(this, `transcription-bedrock-serverless-statemachine`, {
			stateMachineProps: {
				stateMachineName: `transcription-bedrock-serverless-statemachine`,
				definitionBody: sfn.DefinitionBody.fromChainable(chain),
				role: stepFunctionRole,
			},
			eventRuleProps: {
				ruleName: `transcription-bedrock-serverless-statemachine-event-rule`,
				eventPattern: {
